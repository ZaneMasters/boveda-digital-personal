// src/features/attachments/pages/AttachmentsPage.tsx
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--text-primary)' }}>Attachments</h1>
      ...
      <div className="vault-item p-12 flex flex-col items-center justify-center gap-4 text-center">
        <Paperclip className="w-12 h-12 text-surface-700" />
